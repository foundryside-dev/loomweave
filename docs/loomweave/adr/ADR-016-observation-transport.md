...
- [Loomweave v0.1 system design §9 (Observation transport)](../1.0/system-design.md) (lines 916-921) — the passage reversed by this ADR; updated in the same commit.
- [Loomweave v0.1 system design §11 (Capability negotiation)](../1.0/system-design.md) (lines 1122-1141) — observation HTTP presence moves from v0.1 fallback trigger to v0.2 feature-flag detection.
- [Loomweave v0.1 detailed design §9.1 Filigree prerequisites](../1.0/detailed-design.md) (lines 1333-1351) — `POST /api/v1/observations` moved from "Required for v0.1 ship" to "Nice-to-have (v0.2+)".
