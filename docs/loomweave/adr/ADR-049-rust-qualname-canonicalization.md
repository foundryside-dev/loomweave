...
**Status**: Accepted (amended 2026-06-09 — §1 inherent-impl ordinal dropped, Option (b); §2 self-type concrete generic args folded into `<Type>`)
**Date**: 2026-06-08
