...
5. **`docs/clarion/v0.1/system-design.md` §6** — pipeline phases. Phase 3 placement, what it reads from storage, what it writes.
6. **`docs/clarion/v0.1/detailed-design.md`** — search for `subsystem`, `cluster`, `Phase 3`. Schema shape if present, properties expected on the subsystem entity.
