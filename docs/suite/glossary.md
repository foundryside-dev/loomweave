...
> **`~/weft/glossary.md`** (authoritative as of 2026-06-05; public mirror: https://github.com/foundryside-dev/weft).
...
The body of cross-product term tables now lives at `~/weft/glossary.md`. New
