...
//! (`.clarion/embeddings.db`), and returns ranked, SEI-carrying entities. Only
...
use clarion_storage::{EmbeddingStore, embeddings_db_path, entity_by_id};
