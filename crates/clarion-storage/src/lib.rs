...
pub use query::{
    ...
    containing_module_id, current_file_hash, entities_containing_line, entity_at_line,
    entities_by_kind, entities_by_tag, entities_with_wardline_facts, entity_briefing_block_reason,
    entity_by_id, entity_visibility, existing_entity_ids,
