...
fn findings_for_emit_joins_entity_path_and_preserves_nullable_location() {
    ...
    insert_finding(
        ...
        "run-1",
        "LMWV-FACT-CLUSTERING-WEAK-MODULARITY",
        "fact",
        "INFO",
        "core:subsystem:abcd",
        "[]",
    ...
    assert_eq!(defect.rule_id, "LMWV-PY-STRUCTURE-001");
...
fn findings_for_emit_excludes_briefing_blocked_anchors() {
    ...
    // carries no briefing_blocked reason. The LMWV-SEC-UNREDACTED-SECRETS-ALLOWED
