...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 8,
        name: "0008_run_owner_heartbeat",
        sql: include_str!("../migrations/0008_run_owner_heartbeat.sql"),
    },
    Migration {
        version: 9,
    ...
    Migration {
        version: 15,
        name: "0015_plugin_resolver_environment",
        sql: include_str!("../migrations/0015_plugin_resolver_environment.sql"),
    },
];
